    ...
    return (
        ...
        <div className="uparzon-container-fluid">
            <div className="row align-items-center no-gutters pt-2 pb-2">
               <div className={`${Styles.news_letter_left} col-md-4 d-flex align-items-center justify-content-center justify-content-md-start mb-2 mb-sm-0`}>
                    <img src={"assets/svg/icons/paper-plane.svg"} className='mr-3' alt="news letter" />
            ...
            <div className="col-md-3 d-flex align-items-center justify-content-center mb-2 mb-sm-0">
                <small className='text-light'>Be the First to Know. Sign up for newsletter today</small>    
            </div>
            <div className="col-md-5 mb-2 mb-sm-0">
                <div className={`${Styles.news_letter_form} row no-gutters align-items-center m-auto col-11`}>
